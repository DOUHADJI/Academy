...
<x-file-wrapper>
    ...
    <div class="bg-white">
        ...
        <div class="p-12">
            ...
            <x-file-en-tete title="Fiche des UEs" :school-year="$payment->school_year" />
                    ...
                    <div class="px-8 py-6 text-gray-600 ">
                        <div class=" w-full">
                            <div class="flex justify-between items-center my-4 w-full pl-8 ">
                                ...
                                {{-- <img src="{{ Storage::url($payment->student->infos->avatar) }}"
                                alt="avatar" class="object-cover h-44 w-32 " /> --}}
