...
import { studentSidebarButtons } from "@/utils/sidebarButtons";
        ...
        <>
            <UserContextProvider>
                ...
                <div className="flex top-[0] fixed right-0 left-0 bottom-0">
                    <MobileSidebar buttons={studentSidebarButtons} />
                    <Sidebar  buttons={studentSidebarButtons} />
                    <div className="flex flex-col relative justify-center h-full overflow-y-hidden bg-white  md:w-4/5">
                    <TopBar />
